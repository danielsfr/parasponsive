...
(function(f,h){"function"==typeof define&&define.amd?define(["eventEmitter/EventEmitter","eventie/eventie"],function(e,b){return h(f,e,b)}):"object"==typeof exports?module.exports=h(f,require("eventEmitter"),require("eventie")):f.imagesLoaded=h(f,f.EventEmitter,f.eventie)})(window,function(f,h,e){function b(b,a){for(var c in a)b[c]=a[c];return b}function l(b){var a=[];if("[object Array]"===p.call(b))a=b;else if("number"==typeof b.length)for(var c=0,d=b.length;d>c;c++)a.push(b[c]);else a.push(b);return a}
