...
/* your css files */ /*
require_once(get_template_directory() . '/css/bootstrap.css');
require_once(get_template_directory() . '/css/font-awesome.min.css');
require_once(get_template_directory() . '/css/fresco.css');
require_once(get_template_directory() . '/css/jquery.bxslider.css');
require_once(get_template_directory() . '/css/magnific-popup.css');
require_once(get_template_directory() . '/css/main.css');
require_once(get_template_directory() . '/css/normalize.css');
require_once(get_template_directory() . '/css/style.css');
require_once(get_template_directory() . '/css/team.css');
require_once(get_template_directory() . '/fonts/zocial.css');
